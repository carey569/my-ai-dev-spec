...
| | `.claude/skills/*/SKILL.md` — 15 个项目级 AI Skills |
...
所有 15 个 Skills 会生成到每个项目中，无论项目类型。
...
│           ├── commands/           # Skills 命令模板
│           │   ├── common/         #   通用（8 个，含 prd）
│           │   ├── new-project/    #   新建项目（1 个）
│           │   ├── maintenance/    #   维护项目（3 个）
│           │   └── refactor/       #   重构项目（3 个）
│           └── skills/             # Skills 多文件模板
│               └── common/prd/     #   PRD 技能（SKILL.md + references/）
├── CLAUDE.md                    # 插件自身的开发规范
└── README.md
```
